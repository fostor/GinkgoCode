...
namespace Fostor.GinkgoCode.T4EngineHost
{
    [Serializable]
    public class EntityHost : ITextTemplatingEngineHost
    {
        ...
        public EntityHost()
        {
            ...
            AddAssemblyLocation(typeof(Fostor.GinkgoCode.T4EngineHost.EntityHost).Assembly.Location);
            AddNamespace("Fostor.GinkgoCode.T4EngineHost");
            AddNamespace("Fostor.GinkgoCode.Helpers");
            AddNamespace("Fostor.GinkgoCode.EntityMeta");
            AddNamespace("System");
